      ...
      .pipe(
        ...
        map((res) => {
          ...
          return new NbAuthResult(
            ...
            [],
            this.getOption('messages.getter')(module, modifiedResponse, this.options),
            this.createToken(this.getOption('token.getter')(module, modifiedResponse, this.options), requireValidToken)
          );
        }),
        catchError((err, res) => {
